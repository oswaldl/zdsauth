...
log4j = {
    ...
    error  'org.codehaus.groovy.grails.web.servlet',        // controllers
           ...
           'com.odobo.grails.plugin.springsecurity'

    info    'com.odobo.grails.plugin.springsecurity'

    debug   'com.odobo.grails.plugin.springsecurity'
}
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.zy.zds.auth.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.zy.zds.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'com.zy.zds.auth.Role'
